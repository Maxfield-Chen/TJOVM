...
var game = new Phaser.Game(800, 600, Phaser.CANVAS, 'TCWS', { preload: preload, create: create, update: update, render: render });
...
function preload() {
    ...
    game.load.image('smoke', 'assets/sprites/spirit.png');
